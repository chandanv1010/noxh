            ...
            <div class="ibox-content">
                ...
                @if(request('product_id'))
                    <div class="alert alert-info">
                        ...
                        <a href="{{ route('project.faq.index') }}">Xem tất cả dự án</a>
                    </div>
                @endif

                <form action="{{ route('project.faq.index') }}">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between">
                            ...
                            <div class="action">
                                <div class="uk-flex uk-flex-middle">
                                    ...
                                    <a href="{{ route('project.faq.create') }}" class="btn btn-danger"><i class="fa fa-plus mr5"></i>Thêm mới</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered mt20">
                    <thead>
                        <tr>
                            ...
                            <th>Câu hỏi</th>
                            <th style="width:160px;">Thuộc dự án</th>
                        ...
                        @foreach($faqs as $o)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('project.faq.edit', $o->id) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('project.faq.delete', $o->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
