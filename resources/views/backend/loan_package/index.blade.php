    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form action="{{ route('loan.package.index') }}">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between">
                            ...
                            <div class="action">
                                <div class="uk-flex uk-flex-middle">
                                    ...
                                    <a href="{{ route('loan.package.create') }}" class="btn btn-danger"><i class="fa fa-plus mr5"></i>Thêm mới</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered mt20">
                    <thead>
                        <tr>
                            ...
                            <th>Tên gói</th>
                            <th style="width:180px;">Ưu đãi</th>
                            <th class="text-center" style="width:120px;">Sau ưu đãi</th>
                            <th class="text-center" style="width:100px;">Vay tối đa</th>
                    ...
                    <tbody>
                        @foreach($packages as $o)
                            <tr>
                                    ...
                                    <td>{{ $o->preferential_rate !== null ? $o->preferential_rate.'%/năm · '.($o->preferential_months ?: 0).' tháng' : '—' }}</td>
                                    <td class="text-center">{{ $o->standard_rate !== null ? $o->standard_rate.'%/năm' : '—' }}</td>
                                    <td class="text-center">{{ $o->max_loan_ratio !== null ? $o->max_loan_ratio.'%' : '—' }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('loan.package.edit', $o->id) }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('loan.package.delete', $o->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    </td>
                            </tr>
                        @endforeach
